...
Ordinary delimited continuations \cite{danvy1989functional} can be defined as a function to register a callback function (Listing~\ref{Continuation}), which is similar to the signature of \lstinline{Dsl} type class.
