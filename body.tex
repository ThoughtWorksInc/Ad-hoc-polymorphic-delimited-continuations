...
An ordinary delimited continuation is a CPS function whose implementation is predetermined. In contrast, we introduced ad-hoc polymorphic delimited continuation, the \lstinline{Dsl} type class, whose implementation is adaptive to the enclosing domain. TODO
