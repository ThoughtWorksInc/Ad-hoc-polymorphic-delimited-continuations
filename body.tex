...
The behavior of our CPS-transformation compiler plug-ins is similar to do-notation with \lstinline{RebindableSyntax} in Haskell. Both delimited continuation and monad-like \lstinline{flatMap} operations are supported.

\subsection{Ad-hoc polymorphic delimited continuations}

% control flow can be totally eliminated at compile time


% a special instruction prefix is translated to a function call with 
