...
To make \lstinline{Yield} LDK available in other domain, just provides \lstinline{Dsl} type class instance for other types.

Listing \ref{continuationDsl} shows a \lstinline{Dsl} allows a LDK be available in \lstinline{Domain!!Value} as long as the LDK is available for \lstinline{Domain}.
