...
Alternately, Bob can use the pre-defined function \lstinline{reset} \footnote{The difference between underscore and \lstinline{reset} will be discussed in Section \ref{Creating library-defined keywords}} instead of the underscore placeholder (Listing \ref{bobLoggingParserReset}). 
