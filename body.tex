...
\begin{figure}[h t b p]
  ...
  digraph {
    ...
    M [ label="Atomic operation" ]
    T1 [ label="Nested transformed monadic data type"]
    T2 [ label="Nested transformed monadic data type"]
    M -> T1 [ label="lift" ]
    T1 -> T2 [ label="transformed bind operator" ]
  }
  \end{dot2tex}
